...
AG2 group chat speaker selection event (indicates turn boundary).
...
| Field | Type | Description |
|-------|------|-------------|
| `selected_speaker` | string | Agent selected to speak |
| `next_speaker` | string | Next speaker in sequence (optional) |
