function ChatMessage({ message, message_from, agentName }) {
  console.log('💬 ChatMessage render:', { message: message?.substring(0, 50) + '...', message_from, agentName, hasMessage: !!message });
