...
async def define_agents():
    ...
    logger.debug("✅ [GENERATOR] LLM configs loaded (streaming handled by AG2 IOStream)")
    ...
    logger.debug("🔧 [GENERATOR] Creating ContextAgent...")
...
4. Wait for user interaction before completing""",
    ...
    logger.info("🔧 [GENERATOR] Tools will be registered via modular tool system")
