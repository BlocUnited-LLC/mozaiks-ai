...
Usage:
    from core.auth.websocket_auth import authenticate_websocket, WebSocketUser
...
async def authenticate_websocket(
    ...
    # Only allow query param extraction if explicitly enabled
    if not token:
        ...
        if allow_query_token:
            ...
            logger.warning("WebSocket query param token rejected (MOZAIKS_WS_ALLOW_QUERY_TOKEN not enabled)")
