...
async def define_agents(workflow_name: str):
    ...
    logger.debug(f"🔧 [AGENTS] Loaded config with {len(agent_configs)} agent definitions")
    ...
    # NOTE: UserProxyAgent is auto-generated by groupchat_manager.py
    ...
    for agent_name, agent_config in agent_configs.items():
        logger.debug(f"🔧 [AGENTS] Creating {agent_name}...")
    ...
    # via workflow YAML configuration and the WorkflowToolRegistry
    logger.info("🔧 [AGENTS] Tools will be registered via modular tool system")
