...
class TestRuntimeExtensions:
    ...
    def test_extension_loader_import(self):
        ...
        from mozaiksai.core.runtime.extensions import get_workflow_api_router, get_workflow_lifecycle_hooks
...
class TestEventSystem:
    ...
    def test_event_dispatcher_import(self):
        ...
        from mozaiksai.core.events.dispatcher import UnifiedEventDispatcher
